                                ...
                                <table class="table table-bordered table-hover mb0 paytable">
                                  ...
                                  <tr>
                                    ...
                                    <tr class="paybtngray">
                                      ...
                                      <td><button type="submit"  name="search"  value="" class="btn btn-info buttondarkgray"><?php echo $this->lang->line('pay_with_payfast'); ?> <i class="fa fa-chevron-right valign-middle"></i></button></td>
                                  </tr>    
                                </table>
                                </form>
                            </div>
