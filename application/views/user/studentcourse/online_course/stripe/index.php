                                ...
                                <tr class="paybtngray">   
                                  ...
                                  <td> 
                                     <script
                                        ...
                                        data-amount="<?php echo convertBaseAmountCurrencyFormat($params['total_amount'] * 100); ?>"
                                        data-name="<?php echo $this->customlib->getSchoolName(); ?>"
                                        data-description="<?php echo $this->currency_name; ?>"
                                        data-image="<?php echo base_url('uploads/school_content/logo/' . $setting[0]['image']); ?>"
                                        data-locale="auto"
                                        data-zip-code="true"
                                        data-currency="<?php echo $this->currency_name; ?>"
                                        >
                                    </script>  
                                   </td>
                                  </tr>      
