                            ...
                            <table class="table table-striped table-bordered table-hover example">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo $this->lang->line('author_mark'); ?></th>
                                          <th><?php echo $this->lang->line('sub_title'); ?></th>
                                        <th><?php echo $this->lang->line('corporate_author'); ?></th>
                                      
                                        
                                        <th><?php echo $this->lang->line('subject'); ?></th>
                                        <th><?php echo $this->lang->line('rack'); ?></th>
                                        <th><?php echo $this->lang->line('rack_number'); ?></th>
                                        <th><?php echo $this->lang->line('publication_year'); ?></th>
                                        <th><?php echo $this->lang->line('volume'); ?></th>
                                        <th><?php echo $this->lang->line('pages'); ?></th>
...
if ($book['description'] == "") {
        ...
        ?>
                                                ...
                                                <td class="mailbox-name"> <?php echo $book['author'] ?></td>
                                                    <td class="mailbox-name"> <?php echo $book['sub_title'] ?></td>
                                                <td class="mailbox-name"> <?php echo $book['corporate_author'] ?></td>
                                            
                                                <td class="mailbox-name"> <?php echo $book['subject'] ?></td>                        
                                                <td class="mailbox-name"> <?php echo $book['rack'] ?></td>
                                                <td class="mailbox-name"> <?php echo $book['rack_no'] ?></td>
                                                <td class="mailbox-name text-right"> <?php echo $book['publication_year'] ?></td>
                                                               <td class="mailbox-name text-right"> <?php echo $book['volume'] ?></td>
                                                                                            <td class="mailbox-name text-right"> <?php echo $book['pages'] ?></td>
                                                                                                                      <td class="mailbox-name text-right"> <?php echo $book['item_type'] ?></td>                                            <td class="mailbox-name text-right"> <?php echo $book['book_language'] ?></td>
                                                                                                                                       <td class="mailbox-name text-right"> <?php echo $book['vendor'] ?></td>
