                    ...
                    <div class="row">
                        <style>
                            @media print {
                                ...
                                .landscape-print .col-md-4 {
                                    flex: 0 0 auto;
                                    /* Ensure columns maintain their width */
                                    width: 33.33%;
                                    /* Set width for each column */
                                    max-width: none;
                                    /* Allow columns to expand beyond their max-width */
                                    page-break-inside: avoid;
                                    /* Avoid breaking columns across pages */
                                }
                            }
                        </style>
                        <?php
                                ...
                                <div class="box-body">
                                    ...
                                    if (!empty($student_due_fee)) {
                                        ...
                                        foreach ($student_due_fee as $student_key => $student_value) {
                                            $final_due_date = $student_value['fees_list'][0]->final_due_date;
                                            if ($final_due_date != '') {
                                                break;
                                            }
                                        }
                                    ...
                                    ?>
                                        ...
                                        <div class="row" id="printDiv" style="display: none;">
                                            ...
                                            ?>
                                                ...
                                                <div class="row" style="page-break-after: always; padding: 5px;">
                                                    <div class="col-md-4 col-sm-4" style="border-right:1px dashed; ">

                                                        <h5 style=" text-align: center; font-weight: bold;">
                                                            <span> <img src="<?php echo  base_url('/uploads/cbseexam/template/left_sign/AVICENNA-LOGO-01-1.png') ?>" width="50" height="50" /></span>
                                                            "THE AVICENNA SCHOOL (PVT) LTD." <p style="margin-top: -10px;">AVICENNA JOHAR CAMPUS</p>
                                                        </h5>
                                                        <p>C 262, Block 14 Gulistan-E Johar, Karachi - Tel:02134012708-9</p>
                                                        <h6 style="font-weight: bold;">BANK AL HABIB LIMITED ZAMZAMA BRANCH KARACHI</h6>
                                                        <h6 style="font-weight: bold;">Bank Account No.: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; PK56 BAHL 1005 0081 0399 9101</h6>
                                                        <h6 style="font-weight: bold;">NTN No.: 1349192-0</h6>
                                                        <br />
                                                        <div class="row">
                                                            <div class="col-sm-6 ">
                                                                <p>Invoice For the period :</p>
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <p>2024-2025</p>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <p><?php echo $student_value['admission_no']; ?></p>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <p><?php echo $this->customlib->getFullName($student_value['firstname'], $student_value['middlename'], $student_value['lastname'], $sch_setting->middlename, $sch_setting->lastname); ?></p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <p> <?php echo $student_value['father_name'] ?></p>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <p> <?php echo $student_value['class'] . " (" . $student_value['section'] . ")" ?></p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row" style="font-weight: bold;">
                                                            <br />
                                                            <div class="col-sm-6" style="border-bottom: 1px solid;border-top: 1px solid;">
                                                                <p>Fee Head</p>
                                                            </div>
                                                            <div class="col-sm-6" style="border-bottom: 1px solid;border-top: 1px solid;">
                                                                <p>Amount</p>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-12">
                                                                ...
                                                                foreach ($student_value['fees_list'] as $fee_key => $fee_value) {
                                                                    if (($final_due_date  != "0000-00-00" && $final_due_date  != NULL) && (strtotime($final_due_date) < strtotime(date('Y-m-d')))) {
                                                                ...
                                                                ?>
                                                                    <div class="row">
                                                                        <div class="col-sm-6"> <?php
                                                                                                ...
                                                                                                ?></div>
                                                                        <div class="col-sm-6"> <?php
                                                                                                echo amountFormat($fee_type_amount); ?></div>
                                                                    </div>
                                                                <?php } ?>
                                                            </div>

                                                        </div>
                                                        <div class="row" style="font-weight: bold; border-bottom: 1px solid; border-top: 1px solid;">
                                                            <div class="col-sm-6">
                                                        ...
                                                        <div class="row" style="font-weight: bold;">
                                                            <div class="col-sm-6">
                                                                <p>Payable after Due Date :</p>
                                                            </div>

                                                            <div class="col-sm-6">
                                                                <p><?php echo  $total_amount + 1000 ?></p>
                                                            </div>
                                                        </div>
...
?></span>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <p style="background-color: black; color: white; font-weight: bold;">Instructions for Bank:</p>
                                                                <p>Please mention Gr.No. <?php echo $student_value['admission_no']; ?>in Remarks</p>
                                                                <p style="background-color: black; color: white;font-weight: bold; ">BANK COPY</p>
                                                            </div>
                                                        </div>
...
?></span>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <p style="background-color: black; color: white; font-weight: bold;">Instructions for Bank:</p>
                                                                <p>Please mention Gr.No. <?php echo $student_value['admission_no']; ?> in Remarks</p>
                                                                <p style="background-color: black; color: white;font-weight: bold; ">STUDENT COPY</p>
                                                            </div>
                                                        </div>
...
?></span>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <p style="background-color: black; color: white; font-weight: bold;">Instructions for Bank:</p>
                                                                <p>Please mention Gr.No. <?php echo $student_value['admission_no']; ?> in Remarks</p>
                                                                <p style="background-color: black; color: white;font-weight: bold; ">SCHOOL COPY</p>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <tr class="dark-gray">
                                                                ...
                                                                <td align="left" class="text text-left"> <?php
                                                                                                            if ($final_due_date == "0000-00-00") {
                                                                                                                ...
                                                                                                                echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($final_due_date));
                                                                                                            }
                                                                                                            ?>
                                                                </td>
        ...
        ?>-->
                                    ...
                                    ?>
                                        ...
                                        <tr class="box box-solid total-bg">
                                            ...
                                            <td align="left" class="text text-RIGHT"><?php echo $this->lang->line('grand_total'); ?></td>
