...
?></td>
            ...
            <tr>
                <th><?php echo $this->lang->line('lecture_youtube_url'); ?></th>
                <td><?php echo $result['lacture_youtube_url'] ?></td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2"><b><?php echo $this->lang->line('attachment') ?></b><br><?php echo $result['attachment']; ?></td>
            </tr>
        </table>
      </div>
