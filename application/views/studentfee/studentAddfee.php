<!-- add by shahmeer ad nr === date option  -->
<style type="text/css">
    .checkbox-inline+.checkbox-inline,
    .radio-inline+.radio-inline {a
        margin-left: 8px;
    }
</style>
<?php
...
foreach ($student_due_fee as $student_key => $student_value) {
    ...
    $final_due_date = $student_value->fees[0]->final_due_date;
    if ($final_due_date != "") {
        break;
    }
}
                        ...
                        <div class="row no-print mb10">
                            <div class="col-md-12 mDMb10">
                                <div class="float-rtl-right float-left">
                                    ...
                                    <label for="datepicker">Select Final Due Date:</label>
                                    <input type="date" id="datepicker" value="<?php echo ($final_due_date ?? "") ?>">
                                    <?php
                            ...
                            <table class="table table-striped table-bordered table-hover example table-fixed-header">
                                <thead class="header">
                                    <tr>
                                        ...
                                        <th class="text text-right"><?php echo $this->lang->line('discount'); ?> <span>
                                ...
                                <tbody>
                                    ...
                                    foreach ($student_due_fee as $key => $fee) {
                                        ...
                                        foreach ($fee->fees as $fee_key => $fee_value) {
                                            ...
                                            $discount_percentage = $fee_value->discount_amount / 100;
                                            $total_balance_amount += amountFormat($feetype_balance - ($feetype_balance * $discount_percentage));
                                    ...
                                    ?>
                                            ...
                                            ?><tr class="danger font12"><?php } else { ?>
                                                <tr class="dark-gray">
                                                <?php } ?>
                                                <td>
                                                ...
                                                <td align="left" class="text text-left width85">
                                                    ...
                                                    ?><span class="label label-success"><?php echo $this->lang->line('paid'); ?></span><?php } else if (!empty($fee_value->amount_detail)) { ?><span class="label label-warning"><?php echo $this->lang->line('partial'); ?></span><?php } else { ?><span class="label label-danger"><?php echo $this->lang->line('unpaid'); ?></span><?php } ?>
                                                </td>
                                                ...
                                                <td class="text text-right"><?php
                                                                            echo amountFormat($fee_value->discount_amount) . "%";
                                                                            $discount_total_amount += $fee_value->discount_amount;
                                                                            ?></td>
                                                <!--<td class="text text-right"><?php
                                                ...
                                                <td class="text text-right"><?php
                                                                            ...
                                                                            if ($feetype_balance > 0) {
                                                                                ...
                                                                                echo amountFormat($feetype_balance - ($feetype_balance * $discount_percentage));
                                                                            }
                                                                            ?>
                                                </td>
                                                <td width="100">
                                                    <div class="btn-group">
                                                        <div class="pull-right">
                                                            ...
                                                            <button type="button" data-amount-id="<?php echo  $fee->fees[$fee_key]->amount ?>" data-amount_discount="<?php echo  $fee->fees[$fee_key]->discount_amount ?>" data-student_session_id="<?php echo $fee->student_session_id; ?>" data-student_fees_master_id="<?php echo $fee->id; ?>" data-fee_groups_feetype_id="<?php echo $fee_value->fee_groups_feetype_id; ?>" data-group="<?php echo ($fee_value->is_system) ? $this->lang->line($fee_value->name) . " (" . $this->lang->line($fee_value->type) . ")" : $fee_value->name . " (" . $fee_value->type . ")"; ?>" data-type="<?php echo ($fee_value->is_system) ? $this->lang->line($fee_value->type) : $fee_value->code; ?>" class="btn btn-xs btn-default myCollectFeeBtn <?php echo $display_none; ?>" title="Add Discount" data-toggle="modal" data-target="#myFeesDiscountModal" data-fee-category="fees" data-trans_fee_id="0"><i class="fa fa-plus"></i></button>
                                                            <?php if ($this->rbac->hasPrivilege('collect_fees', 'can_add')) { ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
                            ...
                            <div class="col-sm-9">
                                <div class="row">
                                    <div class="col-md-5 col-sm-5">
                                        <div class="">
                                            <input type="text" class="form-control" id="amount_discounts" value="0">
                                            <span class="text-danger hidden" id="amount_discounts_error">percentage is not greater than 100</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-5 col-sm-5">
                                        <div class="">
                                            <input type="text" disabled class="form-control" id="amount_fine" value="0">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn cfees save_button_discount_fee" id="load" data-action="collect" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> <?php echo $this->lang->line('processing'); ?>"> Save </button>
                ...
                <div class="form-horizontal balanceformpopup">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="inputPassword3" class="col-sm-3 control-label"><?php echo $this->lang->line('amount'); ?> (<?php echo $currency_symbol; ?>)<small class="req"> *</small></label>
                            <div class="col-sm-9">
                                <input type="text" autofocus="" class="form-control modal_amount" id="amount" value="<?php echo amountFormat($fee_paid); ?>">
                                <span class="text-danger" id="amount_error"></span>
                            </div>
                        </div>
                        <!--<div class="form-group">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        // Send AJAX request when date changes
        $("#datepicker").on('change', function() {
            // Get the selected date
            var selectedDate = $(this).val();
            const base_url = '<?php echo base_url() ?>';
            const fee_groups_feetype_id = $(this).data('fee_groups_feetype_id');

            // Send AJAX request
            $.ajax({
                url: base_url + 'financereports/createfinalDueDate',
                type: 'POST', // or 'GET'
                data: {
                    'fee_groups_feetype_id': "",
                    'final_due_date': selectedDate
                },
                success: function(response) {
                    // Handle success response
                    alert("Success message: " + JSON.parse(response).message);

                    successMsg(JSON.parse(response).message);
...
<script type="text/javascript">
    $(document).on('click', '.save_button_discount_fee', function() {
        var fee_groups_feetype_id = parseInt($('#fee_groups_feetype_id').val())
        var amount_discount = parseInt($('#amount_discounts').val());
        if (isNaN(fee_groups_feetype_id) || isNaN(amount_discount)) {
            alert("Invalid input. Please enter valid numbers.");
            return;
        }
        if (amount_discount > 100) {
            $('#amount_discounts').removeClass('hidden');
            alert('percentage is not greater than 100')
        } else {
            console.log(fee_groups_feetype_id);
            $.ajax({
                type: "post",
                url: '<?php echo site_url("studentfee/addFeeDiscount") ?>',
                dataType: 'JSON',
                data: {
                    'fee_groups_feetype_id': fee_groups_feetype_id,
    ...
    $("#myFeesDiscountModal").on('shown.bs.modal', function(e) {
        ...
        var modal = $(this);
        const amount_discount = data.amount_discount;
        var fee_groups_feetype_id = data.fee_groups_feetype_id;
        $('#fee_groups_feetype_id').val(fee_groups_feetype_id);
        $('#amount_discounts').val(amount_discount)

        $('#amount').val(data.amountId)
        $('.fees_title').html("");
