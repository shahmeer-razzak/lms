...
<body>
    ...
    ?>
        ...
        <div class="row" style="page-break-before: always; padding: 5px;">
            <div class="col-md-4 col-sm-4" style="border-right:1px dashed; ">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <p><?php echo $this->setting_model->getCurrentSessionName() ?></p>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <p><?php echo " (" . $feearray[0]->admission_no . ")"; ?></p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-6">
                        <p><?php echo $this->customlib->getFullName($feearray[0]->firstname, $feearray[0]->middlename, $feearray[0]->lastname, $sch_setting->middlename, $sch_setting->lastname);  ?></p>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <p> <?php echo $feearray[0]->father_name; ?></p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-6">
                        <p><?php echo $feearray[0]->class . " (" . $feearray[0]->section . ")"; ?></p>
                    </div>
                </div>
                ...
                <div class="row" style="font-weight: bold;">
                    ...
                    <!--<div class="col-sm-4" style="border-bottom: 1px solid;border-top: 1px solid;">
                        <p>Fine</p>
                    </div>-->
                </div>
                        ...
                        ?>
                            ...
                            foreach ($feearray as $fee_key => $feeList) {
                                if ($feeList->fee_category == "fees") {
                                    ...
                                    $discount_percentage = $feeList->discount_amount / 100;
                                    $feetype_balance = $feeList->fees - ($fee_paid + $fee_discount);
                                    $total_amount += amountFormat($feeList->amount - ($feeList->amount * $discount_percentage));
                                    $total_discount_amount = $total_discount_amount + $fee_discount;
                                    $total_fine_amount = $total_fine_amount + $fee_fine;
                                    $total_deposite_amount = $total_deposite_amount + $fee_paid;
                                    $total_balance_amount = $total_balance_amount + $feetype_balance;

                                    $total_balance_amount += amountFormat($feeList->amount - ($feeList->amount * $discount_percentage));
                            ...
                            ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6"> <?php
                                                                echo amountFormat($feeList->amount - ($feeList->amount * $discount_percentage)); ?>
                                        </div>
                ...
                <div class="row" style="font-weight: bold; border-bottom: 1px solid; border-top: 1px solid;">
                    ...
                    <div class="col-sm-6">
                        <p><?php echo  amountFormat($total_amount) ?></p>
                    </div>
                ...
                <div class="row" style="font-weight: bold;">
                    ...
                    <div class="col-sm-6">
                        <p><?php echo amountFormat($total_amount + 1000) ?></p>
                    </div>
                </div>
                ...
                <div class="row" style="margin-top: 10%;">
                    <div class=" col-sm-12">
                        <p>issue Date:
                            <span><?php echo  date('D,M m,Y') ?></span>
                        </p>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <p>Please mention Gr.No. <?php echo " (" . $feearray[0]->admission_no . ")"; ?> in Remarks</p>
