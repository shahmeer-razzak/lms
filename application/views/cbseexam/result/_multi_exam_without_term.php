...
foreach ($exam_term_exam_assessment as $assess_key => $assess_value) {
 ...
 ?>             
               <td valign="top" class="text-center" colspan="2"><?php echo $this->lang->line('grand_total'); ?><br/> <?php echo $this->lang->line('out_of'); ?> (150)</td>        
          </tr> 
 <tr>
...
$overall_percentage=getPercent((count($subject_array)*150),$grand_total_exam_weight_percentage);
             ?>
            <td><?php echo $this->lang->line('overall_marks'); ?> : <?php echo two_digit_float($grand_total_exam_weight_percentage, 2)."/".count($subject_array)*150; ?></td>
