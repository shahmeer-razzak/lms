                                    ...
                                    <table class="table table-striped table-bordered table-hover example" >
                                        <thead>
                                            <tr>  
                                                ...
                                                <th class="text-left"><?php echo $this->lang->line('teaching_method'); ?></th>
                                                <th><?php echo $this->lang->line('general_objectives'); ?></th>
                                            ...
                                            foreach ($value['teachers_summary'] as $teachers_summarykey => $teachers_summaryvalue) {
                                                foreach ($teachers_summaryvalue['summary_report'] as $summary_report_key => $summary_report_value) {
                                                    ...
                                                    <tr>  
                                                        ...
                                                        <td class="text-left"><?php echo $summary_report_value['teaching_method'] ?></td>                          
                                                        
                                                        <td class="text-left"><?php echo $summary_report_value['general_objectives']; ?></td>
                ...
                <table class="table table-striped table-bordered table-hover example" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo $this->lang->line('teaching_method'); ?></th>
                            <th><?php echo $this->lang->line('general_objectives'); ?></th>
