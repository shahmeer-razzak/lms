...
class Syllabus extends Admin_Controller
{
    ...
    public function add_syllabus()
    {
        ...
        //$this->form_validation->set_rules('teaching_method', $this->lang->line('teaching_method'), 'trim|required|xss_clean');
         // $this->form_validation->set_rules('general_objectives', $this->lang->line('general_objectives'), 'trim|required|xss_clean');        $this->form_validation->set_rules('date', $this->lang->line('date'), 'trim|required|xss_clean');
        ...
        if ($this->form_validation->run() == false) {
            $msg = array(
                ...
                'time_from'     => form_error('teaching_method'),
                'time_to'       => form_error('general_objectives'),
