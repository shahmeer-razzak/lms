<?php
//update by shahmeer because of printing due date changing //
if (!defined('BASEPATH')) {
...
class Feegrouptype_model extends MY_Model
{
    ...
    public function addDiscountFee($fee_groups_feetype_id, $discount_amount)
    {
        $data_update = array(
        ...
        $result = $this->db->update('fee_groups_feetype', $data_update);
    ...
    public function addfinalDueDate($final_due_date)
    {
        $data_update = array(
    ...
    public function addfinalDueDateById($final_due_date, $fee_groups_feetype_id)
    {
        $data_update = array(
            'final_due_date' => $final_due_date,
        );
