...
class Book_model extends MY_Model
{
    ...
    public function getbooklist()
    {
        $this->datatables
            ...
            ->searchable('book_title,vendor,item_type,book_language,accession_no,description,book_no,isbn_no,publish,author,subject,rack_no,qty," ",perunitcost,postdate," "')
            ->orderable('book_title,vendor,item_type,book_language,description,book_no,isbn_no,publish,author,subject,rack_no,qty," ",perunitcost,postdate," "')
    ...
    public function bookinventory($start_date, $end_date)
    {
        ...
        $this->datatables->query($sql)
            ->orderable('book_title,vendor,item_type,book_language,book_no,isbn_no,publish,author,subject,rack_no,qty,null,null,perunitcost,postdate')
            ->searchable('book_title,vendor,item_type,book_language,accession_no,book_no,isbn_no,publish,author,subject,rack_no,qty,null,null,perunitcost,postdate')
