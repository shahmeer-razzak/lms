...
//making this function for CBSE modal so that the teacher can see only the class that they teach.
    public function get($id = null, $classteacher = null)
    {
        $userdata = $this->customlib->getUserData();
        $role_id  = $userdata["role_id"];
        $carray   = array();
        if (isset($role_id) && ($userdata["role_id"] == 2 & 8) && ($userdata["class_teacher"] == "no")) {
